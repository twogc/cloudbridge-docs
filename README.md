...
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE/) [![Documentation Status](https://img.shields.io/badge/docs-current-brightgreen.svg)](./)
...
* Start with [**Laboratory Reports Overview**](LAB/) for research documentation
...
| Document                                                                                                | Purpose                      | Best For                                       |
| ------------------------------------------------------------------------------------------------------- | ---------------------------- | ---------------------------------------------- |
| [**Laboratory Reports Overview**](LAB/)                                                                 | Research documentation index | Getting started with lab reports               |
